...
// Match inference.py thresholds: average < 10% < elevated < 20% < high
const RISK_STYLES: Record<string, { bg: string; text: string }> = {
  average: { bg: "rgba(102,187,106,0.12)", text: "#66BB6A" },
  elevated: { bg: "rgba(255,183,77,0.12)", text: "#FFB74D" },
  high: { bg: "rgba(239,83,80,0.12)", text: "#EF5350" },
};
